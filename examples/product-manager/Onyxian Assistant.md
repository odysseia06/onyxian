...
### meeting-steward
Captures meeting notes and decisions, preps 1:1s from person notes and open follow-ups, keeps meeting statuses truthful for the Meeting-Board, and maintains the people directory — additive, wikilink-first.
Say e.g.: "log this meeting / capture meeting notes" · "we decided … (record a decision)" · "prep my 1:1 with …" · "add a person / update someone's role" · "close out … / mark follow-ups done"
Where its work lands: `Meetings`
...
- **meeting-notes** — The meetings conventions — dated meeting notes from the typed templates, the scheduled/held/closed lifecycle behind the Meeting-Board views, person notes with next-time agendas, decision capture, and follow-up discipline. Use for any task touching meetings, people notes, or 1:1 preparation.
