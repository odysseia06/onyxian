...
- **meetings** 0.1.2 — Typed meeting and people notes: templates for meetings, 1:1s, and decision-heavy meetings, person notes with role and org, a status-driven Meeting-Board with upcoming and open-follow-up views, a People-Directory Base, and a steward agent for capture, decisions, and 1:1 prep.
...
- **meetings**: Add the people you meet with under People/ from the Person template, then create your first meeting from the Meeting Note, One-on-One, or Decision Meeting template. The Meeting-Board reads meeting statuses; the meeting-notes skill documents the whole flow.
