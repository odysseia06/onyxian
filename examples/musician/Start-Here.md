...
- **music** 0.1.2 — A complete musician's workspace: theory, practice (logs, routines, technique), composition (ideas, melodies, lyrics, song structures), production, listening notes, a knowledge shelf, and copy-per-piece music projects — eleven templates and a practice-log Base.
