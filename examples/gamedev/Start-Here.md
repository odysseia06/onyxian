...
- **projects-gamedev** 0.3.0 — Game projects as living wikis: a copy-per-game template subtree (overview, vision, roadmap, tech design, decision log, plus design/mechanics/world/ content/art/UI areas), with idea and mechanic templates for the incubation stage. Engine code stays a software project; this is the game.
