---
name: practice-loop
description: The music module's working conventions — Goals-note-driven practice targets, truthful session logs, composition capture before projects, and proposal-only routine changes. Use for any task touching practice logs, routines, or composition ideas.
---
