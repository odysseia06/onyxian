...
|---|---|---|---|
| `{{variable}}` | the Onyxian engine | **once, at `apply` time** | user tailoring: folder names, cadences; plus the globals `{{onyxian.today}}`, `{{onyxian.vault_name}}`, `{{onyxian.templates_root}}` |
