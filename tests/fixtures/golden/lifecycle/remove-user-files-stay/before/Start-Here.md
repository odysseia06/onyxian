...
- **demo** 0.1.0 — Synthetic demo module for the lifecycle goldens: a folder, two managed templates (one retired in v2), and one seed (changed in v2 but never redelivered to existing vaults).
