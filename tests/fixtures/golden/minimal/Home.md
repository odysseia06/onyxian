...
This vault was scaffolded by Onyxian on 2026-01-01. Everything here is plain files: the framework never needs to run for the vault to work, and no agent is load-bearing for your notes.
...
- Domain modules (daily notes, academic, fitness, research, projects, and more) are enabled per-vault, with your folder names — added any time with `onyxian add <module>`.
